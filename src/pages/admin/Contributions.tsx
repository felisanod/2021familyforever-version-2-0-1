          ...
          {filtered.map(c => (
            <article key={c.contribution_id} className="card p-4 sm:p-5 flex flex-col gap-3">
              ...
              <div className="grid grid-cols-4 gap-2 text-center">
                ...
                <MiniCount label="Wamekamilisha" value={c.completed_members} tone="success" />
        ...
        {detail && (
          <div className="space-y-4">
            ...
            <dl className="grid grid-cols-2 gap-4 text-sm">
              ...
              <Info label="Wamekamilisha" value={String(detail.completed_members)} />
              <Info label="Wamekamilisha Kiasi" value={String(detail.partial_members)} />
