...
export function exportContributionPdf(
  ...
  const infoPairs: [string, string][] = [
    ...
    ['Wamekamilisha', String(contribution.completed_members)],
    ['Wamekamilisha Kiasi', String(contribution.partial_members)],
  ...
  autoTable(doc, {
    ...
    head: [[
      ...
      'Kilichobaki', 'Lilizidi', 'Hali', 'Maendeleo', 'Malipo ya Mwisho',
    ]],
    body: tableRows,
    theme: 'grid',
